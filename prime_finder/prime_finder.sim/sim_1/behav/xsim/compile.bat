...
REM
REM Generated by Vivado on Sat Sep 27 14:51:44 +0530 2025
...
echo "xvlog --incr --relax -prj tb_prime_finder_vlog.prj"
call xvlog  --incr --relax -prj tb_prime_finder_vlog.prj -log xvlog.log
