...
REM
REM Generated by Vivado on Tue Sep 09 15:57:06 +0530 2025
...
echo "xvlog --incr --relax -prj tb_SR_latch_vlog.prj"
call xvlog  --incr --relax -prj tb_SR_latch_vlog.prj -log xvlog.log
