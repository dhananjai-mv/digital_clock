...
REM
REM Generated by Vivado on Tue Sep 16 10:00:33 +0530 2025
...
echo "xvlog --incr --relax -prj t_ff_tb_vlog.prj"
call xvlog  --incr --relax -prj t_ff_tb_vlog.prj -log xvlog.log
