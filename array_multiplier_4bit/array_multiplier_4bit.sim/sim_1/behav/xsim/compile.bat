...
REM
REM Generated by Vivado on Tue Sep 23 14:41:30 +0530 2025
...
echo "xvlog --incr --relax -prj tb_array_multiplier_vlog.prj"
call xvlog  --incr --relax -prj tb_array_multiplier_vlog.prj -log xvlog.log
