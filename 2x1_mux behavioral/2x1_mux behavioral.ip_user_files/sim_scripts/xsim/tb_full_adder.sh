...
#
# Script generated by Vivado on Tue Aug 26 15:10:59 +0530 2025
# SW Build 6140274 on Thu May 22 00:12:29 MDT 2025
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2025 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : tb_full_adder.sh
...
#
# Usage        : tb_full_adder.sh
#                tb_full_adder.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                tb_full_adder.sh [-reset_run]
#                tb_full_adder.sh [-reset_log]
#                tb_full_adder.sh [-help]
#
...
# script info
echo -e "tb_full_adder.sh - Script generated by export_simulation (Vivado v2025.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./tb_full_adder.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip --snapshot tb_full_adder xil_defaultlib.tb_full_adder xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim tb_full_adder -key {Behavioral:sim_1:Functional:tb_full_adder} -tclbatch cmd.tcl -protoinst "protoinst_files/design_1.protoinst" -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb tb_full_adder.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./tb_full_adder.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: tb_full_adder.sh [-help]\n\
Usage: tb_full_adder.sh [-step]\n\
Usage: tb_full_adder.sh [-lib_map_path]\n\
Usage: tb_full_adder.sh [-reset_run]\n\
Usage: tb_full_adder.sh [-reset_log]\n\
Usage: tb_full_adder.sh [-keep_index]\n\
Usage: tb_full_adder.sh [-noclean_files]\n\n\
