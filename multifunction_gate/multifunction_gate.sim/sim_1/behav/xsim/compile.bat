...
REM
REM Generated by Vivado on Sat Sep 27 14:00:51 +0530 2025
...
echo "xvlog --incr --relax -prj tb_multifunction_gate_vlog.prj"
call xvlog  --incr --relax -prj tb_multifunction_gate_vlog.prj -log xvlog.log
