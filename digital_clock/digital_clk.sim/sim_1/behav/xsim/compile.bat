...
REM
REM Generated by Vivado on Mon Sep 22 17:47:40 +0530 2025
...
echo "xvlog --incr --relax -prj tb_digital_clock_vlog.prj"
call xvlog  --incr --relax -prj tb_digital_clock_vlog.prj -log xvlog.log
