...
REM
REM Generated by Vivado on Tue Sep 09 14:42:38 +0530 2025
...
echo "xvlog --incr --relax -prj tb_ripple_carry_adder_vlog.prj"
call xvlog  --incr --relax -prj tb_ripple_carry_adder_vlog.prj -log xvlog.log
