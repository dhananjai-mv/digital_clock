...
REM
REM Generated by Vivado on Fri Sep 26 18:15:45 +0530 2025
...
echo "xvlog --incr --relax -prj tb_seven_segment_display_vlog.prj"
call xvlog  --incr --relax -prj tb_seven_segment_display_vlog.prj -log xvlog.log
